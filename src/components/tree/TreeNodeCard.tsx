  ...
  const schemes = [
    {
      ...
      shadow: "shadow-[0_4px_12px_rgba(255,224,130,0.2)]",
    }, // Light yellow
    {
      bg: "bg-[#FFF8E1]",
      border: "border-[#FFE082]",
    ...
    }, // Light yellow
    {
      ...
      shadow: "shadow-[0_4px_12px_rgba(165,214,167,0.2)]",
    }, // Light green
    {
      bg: "bg-[#FFF3E0]",
      border: "border-[#FFCC80]",
      shadow: "shadow-[0_4px_12px_rgba(255,204,128,0.2)]",
    }, // Light orange
    {
      bg: "bg-[#F3E5F5]",
      border: "border-[#CE93D8]",
      shadow: "shadow-[0_4px_12px_rgba(206,147,216,0.2)]",
    }, // Light purple
    {
      bg: "bg-[#E3F2FD]",
      border: "border-[#90CAF9]",
      shadow: "shadow-[0_4px_12px_rgba(144,202,249,0.2)]",
    }, // Light blue
  ];
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isHighlighted &&
  "border-2 border-amber-500 shadow-[0_0_30px_rgba(245,158,11,0.7)]"
      )}
    >
      {/* Avatar Container */}
      <div className="relative w-[56px] h-[56px] rounded-full overflow-hidden mb-1.5 bg-white/50 border-2 border-white/60">
        ...
        {node.activePackageCount > 0 || node.memberId == 'COMPANY' ? (
          ...
          <div className="absolute bottom-0.5 right-0.5 w-3 h-3 rounded-full bg-[#FF0000] border-2 border-white" />
        )}
      </div>
      ...
      >
        Id -{" "}
        {node.memberId.length > 10
          ? node.memberId.substring(0, 10)
          : node.memberId}
      </div>
    </div>
  );
