...
const awardImages: Record<number, string> = {
  3: award3,
  4: award4,
  5: award5,
  6: award6,
          ...
          {progressLoading ? (
            ...
            <div className="flex items-center gap-2 text-primary">
              ...
              <span className="font-medium">
                All ranks completed! Congratulations!
              </span>
            </div>
          ) : progress ? (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-muted-foreground">
                    {progress.leftProgress.toLocaleString()} /{" "}
                    {progress.requiredLeft.toLocaleString()}
                  </span>
                </div>
                <Progress
                  value={Math.min(
                    (progress.leftProgress / progress.requiredLeft) * 100,
                    100,
                  )}
                  className="h-2"
                />
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-muted-foreground">
                    {progress.rightProgress.toLocaleString()} /{" "}
                    {progress.requiredRight.toLocaleString()}
                  </span>
                </div>
                <Progress
                  value={Math.min(
                    (progress.rightProgress / progress.requiredRight) * 100,
                    100,
                  )}
                  className="h-2"
                />
